...
build, you stop them wasting their time waiting for builds to finish, and keep them in the flow so their work remains
...
A business-critical plugin for maintaining healthy dependency graphs for JVM, Android, and KMP builds supporting 
many JVM languages.
...
A follow-up to _Herding Elephants_, this post emphasizes the tremendous gains that can accrue from actually maintaining 
an existing build, instead of attempting a risky moonshot migration.

**[Shrinking Elephants](https://autonomousapps.com/blog/shrinking-elephants/post/)**
